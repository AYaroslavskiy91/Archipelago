    ...
    location_table: List[LocationData] = [
        ...
        make_location_data(
            ...
            lambda state: (
                ...
                and (logic.marine_medic_upgrade(state) or adv_tactics)
                and (
                    logic.terran_base_trasher(state)
                    or state.has(item_names.COMMAND_CENTER_SCANNER_SWEEP, player)
                )
            ),
            flags=LocationFlag.BASEBUST,
        ),
        ...
        make_location_data(
            ...
            LocationType.VICTORY,
            logic.ghost_in_a_chance_requirement,
            hard_rule=logic.ghost_in_a_chance_requirement,
        ),
        make_location_data(
            SC2Mission.GHOST_OF_A_CHANCE.mission_name,
            "Terrazine Tank",
        ...
        make_location_data(
            ...
            LocationType.VICTORY,
            lambda state: (
                logic.zerg_common_unit(state) and logic.zerg_basic_anti_air(state)
            ),
        ),
        make_location_data(
            SC2Mission.RENDEZVOUS.mission_name,
        ...
        make_location_data(
            ...
            lambda state: (
                ...
                and (
                    ...
                    or state.has(item_names.OBSERVER, player)
                )
            ),
            flags=LocationFlag.BASEBUST,
        ),
        ...
        make_location_data(
            ...
            lambda state: state.has(item_names.WARP_PRISM, player)
            and (
                adv_tactics or state.has(item_names.PROGRESSIVE_WARP_RELOCATE, player)
            ),
        ),
        make_location_data(
            SC2Mission.THE_MOEBIUS_FACTOR_P.mission_name,
        ...
        make_location_data(
            ...
            lambda state: (
                ...
                and (
                    ...
                    or (
                        adv_tactics
                        and state.has(item_names.PROGRESSIVE_WARP_RELOCATE, player)
                    )
                )
            ),
        ),
        ...
        make_location_data(
            ...
            lambda state: (
                logic.protoss_basic_anti_air(state)
                and (adv_tactics or logic.protoss_common_unit(state))
            ),
        ),
        make_location_data(
            SC2Mission.DEVILS_PLAYGROUND_P.mission_name,
        ...
        make_location_data(
            ...
            LocationType.VICTORY,
            lambda state: (
                logic.terran_common_unit(state) and logic.terran_basic_anti_air(state)
            ),
        ),
        make_location_data(
            SC2Mission.RENDEZVOUS_T.mission_name,
        ...
        make_location_data(
            ...
            LocationType.MASTERY,
            lambda state: (
                logic.terran_competent_comp(state) and logic.terran_base_trasher(state)
            ),
            flags=LocationFlag.BASEBUST,
        ),
        make_location_data(
        ...
        make_location_data(
            ...
            LocationType.VANILLA,
            lambda state: (
                logic.zerg_competent_comp(state) and logic.zerg_base_buster(state)
            ),
            flags=LocationFlag.BASEBUST,
        ),
        make_location_data(
        ...
        make_location_data(
            ...
            lambda state: (
                logic.terran_common_unit(state)
                and (adv_tactics or logic.terran_competent_anti_air(state))
            ),
        ),
        make_location_data(
            SC2Mission.THE_GROWING_SHADOW_T.mission_name,
